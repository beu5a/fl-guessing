...
my_parser.add_argument(
    ...
    type=int,
    required=True,
    help='Homogeneous computational budget for clients')
...
my_parser.add_argument(
    ...
    action='store',
    type=str,
    choices=['round_robin', 'fastest'],
    required=True,
    help='Selection for client selection based on computational budget.')
