...
my_parser.add_argument(
    ...
    action='store',
    type=str,
    choices=['femnist', 'shakespeare', 'celeba', 'synthetic', 'sent140', 'reddit', 'cifar10'],
    default='shakespeare',
...
# TC = -- (Total clients for non-iid)
    ...
    builtins.model_fn = tff_cifar10_model_fn
    TEST_BATCH_SIZE = 512
    check_stopping_criteria = check_stopping_criteria_cifar10
    dataset = CIFAR10Data()
    builtins.keras_model_fn = get_cifar10_cnn2
    preprocess = preprocess_cifar10
    central_test_dataset = dataset.create_test_dataset_for_all_clients().batch(TEST_BATCH_SIZE).map(cifar10_batch_format_fn)
